...
from models import ScoreNetSig
...
model_name = 'scorenetsig_64*2_llava15_v3_w2_f16'
...
model = ScoreNetSig(input_dim=32, hidden_dim=[64,64]).to(device)  # Adjust input_dim as needed
