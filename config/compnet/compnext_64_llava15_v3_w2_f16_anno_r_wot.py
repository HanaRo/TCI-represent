...
model_name = 'compnext_64_llava15_v3_w2_f16_anno_r_wot'
...
model = CompNext(input_dim=32, hidden_dim=[64, 64], comp_dim=[64, 128, 128, 64]).to(device)  # Adjust input_dim as needed
