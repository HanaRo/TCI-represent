...
model_name = 'compnetplus_64_llava15_v3_w2_f16_anno_gr_wot'
...
model = CompNetPlus(input_dim=32, hidden_dim=[64, 64], comp_num=[[0.01, 5.0], [0.01, 20.0]]).to(device)  # Adjust input_dim as needed
