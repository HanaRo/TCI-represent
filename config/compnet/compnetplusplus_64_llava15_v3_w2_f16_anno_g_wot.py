...
from models import CompNetPlusPlus
...
model_name = 'compnetplusplus_64_llava15_v3_w2_f16_anno_g_wot'
...
model = CompNetPlusPlus(input_dim=32, hidden_dim=[64, 64], comp_dim=[32, 64, 64, 32]).to(device)  # Adjust input_dim as needed
...
def infer_step(model=model, test_loader=test_loader):
    ...
    with torch.no_grad():
        for i, batch in enumerate(test_loader):
            ...
            comp_score1 = torch.clamp(comp_score1, 0, 1)  # Ensure compatibility scores are in [0, 1]
