...
@registry.register_task("capability_extraction")
class CapabilityExtractionTask(BaseTask):
    def __init__(self, **kwargs):
        super().__init__()
        self.inst_id_key = "instance_id"
        logging.info("Capability Extraction Task initialized.")
    ...
    def train_epoch(
        ...
        # print(f'###### Training epoch {epoch}, iters_per_epoch {len(data_loader)}') # Enter here
    ...
    def train_iters(
        ...
        # print(f'##### Training epoch {epoch}, start_iters {start_iters}, iters_per_inner_epoch {iters_per_inner_epoch}')
        return self._train_inner_loop(
            epoch=epoch,
